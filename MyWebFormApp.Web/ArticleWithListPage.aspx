<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ArticleWithListPage.aspx.vb" Inherits="MyWebFormApp.Web.ArticleWithListPage" %>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPic" runat="server" EnableViewState="false" CssClass="form-control"
                                        TextMode="MultiLine" placeholder="Enter Detail" />
                                </div>
                                <%--<div class="form-group">
